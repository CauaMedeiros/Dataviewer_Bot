...
Este projeto foi desenvolvido tendo como base a estrutura do repositório [Onifin/generalist-telegram-RAG-bot](https://github.com/Onifin/generalist-telegram-RAG-bot). O projeto original fornece um assistente virtual para Telegram utilizando a abordagem RAG (Retrieval-Augmented Generation), que combina IA generativa com busca eficiente em documentos para responder a perguntas de forma mais precisa e contextualizada.
